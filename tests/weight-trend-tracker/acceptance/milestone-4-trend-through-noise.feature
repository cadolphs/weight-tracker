Feature: See the true trend through daily noise
  ...
  @driving_port @US-004 @contract-shape:pure-function
  ...
  @driving_port @error @US-004 @contract-shape:pure-function
  ...
  @driving_port @US-004 @contract-shape:bounded-change
  ...
  @driving_port @property @kpi @US-004 @contract-shape:pure-function
