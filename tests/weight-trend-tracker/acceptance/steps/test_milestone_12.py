"""Scenario bindings for milestone-12-trend-in-the-record.feature (shared step suite)."""
...
from steps_trend_rows import *  # noqa: F401,F403
from steps_views import *  # noqa: F401,F403

scenarios("../milestone-12-trend-in-the-record.feature")
