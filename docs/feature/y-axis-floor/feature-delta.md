...
- **Empty-window probe — caveat** — `GET /entries?scale=1W&today=2026-01-01` returned the current week (7 entries, `[76.0, 78.5]`): the out-of-skew claim was clamped by design. The empty case is AT-pinned, not demo-pinned ([WHY] 2).
